...
<body class="questions_img">
    <div class="container">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $selectedAnswer == $correctAnswer): ?>
            ...
            <table>
                <caption class="question">What is the capital of Australia?</caption>
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="A" required>A: Sydney</td>
                    <td class="option"><input type="radio" name="answer" value="B">B: Melbourne</td>
                </tr>
                
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="C">C: Canberra</td>
                    <td class="option"><input type="radio" name="answer" value="D">D: Perth</td>
                </tr>
                </table><br>
