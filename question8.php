...
<body class="questions_img">
    <div class="container">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $selectedAnswer == $correctAnswer): ?>
            ...
            <table>
                <caption class="question">In which year did the Titanic sink?</caption>
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="A" required>A: 1905</td>
                    <td class="option"><input type="radio" name="answer" value="B">B: 1918</td>
                </tr>
                
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="C">C: 1920</td>
                    <td class="option"><input type="radio" name="answer" value="D">D: 1912</td>
                </tr>
                </table><br>
