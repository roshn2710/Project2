...
<body class="questions_img">
    <div class="container">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $selectedAnswer == $correctAnswer): ?>
            ...
            <table>
                <caption class="question">In the human body, what is the name of the longest bone?</caption>
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="A" required>A: Tibia</td>
                    <td class="option"><input type="radio" name="answer" value="B">B: Femur</td>
                </tr>
                
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="C">C: Radius</td>
                    <td class="option"><input type="radio" name="answer" value="D">D: Ulna</td>
                </tr>
                </table><br>
