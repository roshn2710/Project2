...
<body class="questions_img">
    <div class="container">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $selectedAnswer == $correctAnswer): ?>
            ...
            <table>
                <caption class="question">What is the national flower of Japan?</caption>
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="A" required>A: Lotus</td>
                    <td class="option"><input type="radio" name="answer" value="B">B: Rose</td>
                </tr>
                
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="C">C: Cherry Blossom</td>
                    <td class="option"><input type="radio" name="answer" value="D">D: Orchid</td>
                </tr>
                </table><br>
