...
<body class="questions_img">
    <div class="container">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $selectedAnswer == $correctAnswer): ?>
            ...
            <table>
                <caption class="question">Which famous playwright wrote Romeo and Juliet?</caption>
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="A" required>A: Charles Dickens</td>
                    <td class="option"><input type="radio" name="answer" value="B">B: William Shakespeare</td>
                </tr>
                
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="C">C: Oscar Wilde</td>
                    <td class="option"><input type="radio" name="answer" value="D">D: Jane Austen</td>
                </tr>
                </table><br>
