...
<body class="questions_img">
    <div class="container">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $selectedAnswer == $correctAnswer): ?>
            ...
            <table>
                <caption class="question">What is the chemical symbol for the element gold?</caption>
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="A" required>A: Ag</td>
                    <td class="option"><input type="radio" name="answer" value="B">B: Au</td>
                </tr>
                
                <tr class = "options">
                    <td class="option"><input type="radio" name="answer" value="C">C: Fe</td>
                    <td class="option"><input type="radio" name="answer" value="D">D: Hg</td>
                </tr>
                </table><br>
